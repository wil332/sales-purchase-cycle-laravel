...
@section('title', __('views.admin.purchase.requests.edit.title'))

@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="{{ route('admin.purchase.requests.update', [$item->no_faktur]) }}" method="POST" class="form-horizontal form-label-left">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">No. Faktur</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" value="{{ $item->no_faktur }}" disabled>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="tanggal_diperlukan" type="date" class="form-control" name="tanggal_diperlukan" value="{{ old('tanggal_diperlukan', optional($item->tanggal_diperlukan)->format('Y-m-d')) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="status" name="status" class="form-control" required>
                            ...
                            <option value="2" {{ (string) old('status', $item->status) === '2' ? 'selected' : '' }}>Parsial</option>
                        </select>
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a class="btn btn-primary" href="{{ route('admin.purchase.requests.index') }}">Batal</a>
