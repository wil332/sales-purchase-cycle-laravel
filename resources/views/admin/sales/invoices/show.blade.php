...
@section('title', __('views.admin.sales.invoices.show.title'))
...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <a class="btn btn-primary" href="{{ route('admin.sales.invoices.edit', [$item->no_invoice_jual]) }}">{{ __('views.admin.sales.invoices.show.edit') }}</a>
            <a class="btn btn-default" href="{{ route('admin.sales.invoices.index') }}">{{ __('views.admin.sales.invoices.show.back') }}</a>
        </div>
    </div>
@endsection
